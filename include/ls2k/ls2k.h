...
/* ACPI regs */
#define LS2H_ACPI_REG_BASE				(LS2H_IO_REG_BASE + 0x00007000)
...
#ifdef GPIO_PINS
#define NAND_SELGPIO ((!!((GPIO_PINS>>44)&0xfffff))<<9)
...
#define SATA_SELGPIO (((GPIO_PINS>>14)&1)<<8)
#define GMAC1_SELGPIO ((!!((GPIO_PINS>>4)&0x3ff))<<3)
#define LS2K_SELGPIO (NAND_SELGPIO|SDIO_SELGPIO|CAN1_SELGPIO|CAN0_SELGPIO|HDA_SELGPIO|PWM_SELGPIO|I2C1_SELGPIO|I2C0_SELGPIO|SATA_SELGPIO|GMAC1_SELGPIO)
#endif
